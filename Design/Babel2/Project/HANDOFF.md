...
**先读**：本目录 STATUS.md 顶部各小节（2026-09-24/25 的 Reader、文章列表、首页修复等，均已提交并推送）、DECISIONS.md 的 ADR-016～030、LESSONS.md 第 30～44 条。根目录的 NOTES-progress.md / CURRENT-STATE.md 是 1.x 时期的旧记录，不代表当前状态。
...
- 下一任务待用户指定。候选：大图上的「刷新」「更多」按钮；设置里暂未放的项目（文章主题、分组方式等，需先做功能）；阅读页栏显隐测试偶发失败；阅读页上拉翻篇手势。
