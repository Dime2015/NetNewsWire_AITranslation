...
来自 Figma 文件 `0kFsVs9DLbE7Um96yrlBKg`（Babel 2.0 设计稿），经 Figma 连接原样导出的 SVG：

| 资源 | Figma 节点 |
|---|---|
| Babel2ReaderClose | Navigation Bar / Reader → Close (18:16) |
| Babel2ReaderMore | Navigation Bar / Reader → More (18:18) |
...
阅读模式图标复用已有的 `BabelReaderReadingMode`（与设计稿 96:2 导出的 SVG 逐字节一致）。
